		...
		return (
			<div className="providerContainer">
				<div className="provider">
					<div className="searchHeader">{providerInfo.provider.displayName}</div>

					{providerInfo.provider.providerActionCallback &&
					providerInfo.provider.providerActionTitle ? (
						<div className="providerAction">
							<div onClick={this.itemClick} className="actionTitle">
								{providerInfo.provider.providerActionCallback
									? providerInfo.provider.providerActionTitle
									: null}
							</div>
