		...
		this.setState(
			{
				...
				showCancelButton:
					typeof data.showCancelButton === 'undefined' ? false : data.showCancelButton,
			},
			this.fitAndShow,
		)
	}
				...
				<div className="content-main-wrapper">
					...
					<div className="content-main-row">
								...
								{Object.keys(this.state.templateDefinitions).map((templateName, i) => {
									...
									return (
										<div
											...
											key={i}
											onClick={() => this.setFocusedTemplateInfo(templateName, true)}
										>
						...
						<div className="content-main-column components-column">
							...
							{this.state.currentComponents.length === 0 && (
								<div className="content-section-components-name">No components.</div>
							)}
						</div>
					</div>
					<div className="content-main-row">
