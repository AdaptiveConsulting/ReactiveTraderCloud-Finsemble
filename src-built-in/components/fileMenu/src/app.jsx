			...
			<FinsembleMenu padding={padding}>
				...
				<FinsembleMenuSection className="menu-primary">
					...
					{window.location.toString().includes('localhost') ? (
						<FinsembleMenuItem
							label="Reset"
							onClick={FileMenuActions.clearCacheRestart}
							title="Delete cache and restart"
						/>
					) : null}
...
function FSBLReady() {
	ReactDOM.render(<FileMenu />, document.getElementById('FileMenu-component-wrapper'))
}
