...
export default class AppList extends React.Component {
	...
	createIcon() {
		if (!this.props.app.icon) {
			return (
				<div
					style={{ backgroundImage: 'url(src/assets/logo-placeholder-52.png)' }}
					className="logo"
				></div>
			)
		}
		if (this.props.app.icon.type === 'fonticon') {
			return (
				<div className="iconContainer">
					<div className={'icon ' + this.props.app.icon.path}></div>
				</div>
			)
		}
			...
			<div className="appItem">
				...
				<div className="containerFooter">
					...
					<div className="footerRight">
						<div className="openButton" onClick={this.itemClick}>
							Open
						</div>
					</div>
				</div>
