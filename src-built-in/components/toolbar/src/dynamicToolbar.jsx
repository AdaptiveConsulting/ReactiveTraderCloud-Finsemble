...
export default class Toolbar extends React.Component {
			...
			for (var i = 0; i < section.length; i++) {
				...
				switch (button.type) {
					...
					case 'reactComponent':
						...
						buttonComponent = (
							<Component key={i} {...button} className={'finsemble-toolbar-button'} />
						)
						break
					case 'workspaceSwitcher':
						buttonComponent = (
							<WorkspaceLauncherButton key={i} {...button}></WorkspaceLauncherButton>
						)
						break
	...
	render() {
		...
		return (
			<FinsembleToolbar onDragStart={this.moveToolbar} onDragEnd={this.onPinDrag}>
				<DragHandle />
				{this.getSections()}
