...
export default class ProcessMonitor extends React.Component {
	...
	render() {
		...
		let totals = this.state.processList.length
		...
		return (
			<div>
				<div className="process-list-wrapper">
					<ListHeader
						fields={
							this.state.viewMode === 'simple' ? SIMPLE_MODE_STATISTICS : ADVANCED_MODE_STATISTICS
						}
					/>
										...
										<ProcessStatistics
											...
											fields={
												this.state.viewMode === 'simple'
													? SIMPLE_MODE_STATISTICS
													: ADVANCED_MODE_STATISTICS
											}
