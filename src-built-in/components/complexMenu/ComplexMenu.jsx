					...
					<div className="complex-menu-container">
						<div className="complex-menu-left-nav">
							<div className="complex-menu-left-nav-header" style={headerImgStyle}>
								{self.props.headerImgUrl !== '' && (
									<img className="complex-menu-left-nav-header-img" src={self.props.headerImgUrl} />
								)}{' '}
								{this.props.title}
							</div>
							{navEntries.map((el, i) => {
								...
								if (el.label === this.state.activeSection) {
									...
									activeContent.push(
										<div key={'entry' + i} className="containerItem active">
											{el.content}
										</div>,
									)
								} else {
									activeContent.push(
										<div key={'entry' + i} className="containerItem">
											{el.content}
										</div>,
									)
								}
