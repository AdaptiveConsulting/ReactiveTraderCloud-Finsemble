	...
	(function(e) {
		...
		if (!d) {
			...
			c.prototype = {
				...
				set hash(e) {
					this._isInvalid ||
						((this._fragment = '#'), '#' == e[0] && (e = e.slice(1)), a.call(this, e, 'fragment'))
				},
				get origin() {
					var e
		...
		!(function() {
			...
			;(n.prototype = {
				set: function(t, n) {
					var o = t[this.name]
					return (
						o && o[0] === t ? (o[1] = n) : e(t, this.name, { value: [t, n], writable: !0 }), this
					)
				},
				get: function(e) {
					var t
		...
		if (n || o) {
			...
			;(i.cloneNode = function(e, t) {
				...
				return (
					...
					t &&
						(n.content.appendChild(h.call(e.content, !0)), this.fixClonedDom(n.content, e.content)),
					n
				)
			}),
				(i.fixClonedDom = function(e, t) {
					if (t.querySelectorAll)
						for (
							var n, o, i = t.querySelectorAll(r), a = e.querySelectorAll(r), s = 0, c = a.length;
							c > s;
							s++
						)
							(o = i[s]),
		...
		u &&
			...
			(function() {
				if ('loading' === document.readyState)
					for (
						var e, t = document.querySelectorAll('link[rel=import]'), n = 0, o = t.length;
						o > n && (e = t[n]);
						n++
					)
						d(e)
		...
		var a = e.path,
			...
			h = {
				...
				nextToParse: function() {
					return (
						(this._mayParse = []),
						!this.parsingElement && (this.nextToParseInDoc(s) || this.nextToParseDynamic())
					)
				},
	...
	window.CustomElements.addModule(function(e) {
		...
		function i(e, t, n) {
			if (((e = window.wrap(e)), !(n.indexOf(e) >= 0))) {
				n.push(e)
				for (
					var o, r = e.querySelectorAll('link[rel=' + a + ']'), s = 0, c = r.length;
					c > s && (o = r[s]);
					s++
				)
