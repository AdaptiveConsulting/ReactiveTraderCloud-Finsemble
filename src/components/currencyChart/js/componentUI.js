...
;(function(definition) {
	...
	if (typeof exports === 'object' && typeof module === 'object') {
		module.exports = definition(
			...
			require('chartiq/js/thirdparty/@webcomponents/custom-elements.min'),
		)
	} else if (typeof define === 'function' && define.amd) {
		define([
			'chartiq/js/chartiq',
			'chartiq/js/thirdparty/@webcomponents/custom-elements.min',
		], definition)
	...
	CIQ.UI.observe = function(params) {
		if (!Object.observe)
			return console.warn(
				'CIQ.UI.observe is deprecated. You must include thirdparty/object-observe.js in your project to use the feature, or use CIQ.UI.observeProperty.',
			)
		var self = this
		...
		Object.defineProperty(obj, property, {
			...
			set: function(value) {
				if (found.value !== value) {
					...
					for (var l = 0; l < found.listeners.length; l++) found.listeners[l](params)
				}
			},
		})
	}
		...
		CIQ.Marker.HeadsUp.placementFunction = function(params) {
			...
			for (var i = 0; i < params.arr.length; ++i) {
				...
				if (top < 0) {
					...
					bottom =
						(useHighs
							? getBottomPixel(stx, panel, containerHeight, stx.getBarBounds(quote).low)
