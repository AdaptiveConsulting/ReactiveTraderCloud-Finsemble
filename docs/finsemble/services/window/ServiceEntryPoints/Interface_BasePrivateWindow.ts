...
export interface BasePrivateWindowInterface {
	_create(params: WindowCreationParams): Promise<any>; // new to FinsembleWindow -- static
	...
	_getCurrentState(params: WindowParams): Promise<any>; // new to FinsembleWindow
	_getOptions(params: WindowParams): Promise<any>; // new to FinsembleWindow
