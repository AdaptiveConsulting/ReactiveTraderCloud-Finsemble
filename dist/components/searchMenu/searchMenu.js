	...
	render() {
		...
		if (this.props.item.actions.length <= 1) {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ className: "resultItem action " + (this.props.isActive ? "bestmatch active" : "") },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "resultName ", onClick: function () {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			"div",
			{ className: "resultItem " + (this.props.isActive ? "bestmatch active" : "") },
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ className: "actions" },
				this.props.item.actions.map(function (action, index) {
					return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ key: "actionbtn" + index, className: "action actionButton", onClick: function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__componentItem__ = __webpack_require__(101);
/*!
* Copyright 2017 by ChartIQ, Inc.
* All rights reserved.
*/
...
class ProviderList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
		this.bindCorrectContext();
		this.state = {};
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				providerInfo.provider.providerActionCallback && providerInfo.provider.providerActionTitle ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "providerAction" },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ onClick: this.itemClick, className: "actionTitle" },
						providerInfo.provider.providerActionCallback ? providerInfo.provider.providerActionTitle : null
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "ff-arrow-right arrow_right_grey" })
				) : null
			),
			this.props.children
		);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ProviderList;
...
function createStore(done) {
	...
	FSBL.Clients.DistributedStoreClient.createStore({ store: "Finsemble-SearchStore-" + FSBL.Clients.WindowClient.options.customData.spawnData.owner, values: defaultData, global: true }, function (err, store) {
		menuStore = store;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./searchMenu.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./searchMenu.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__searchMenu_css__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__searchMenu_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__searchMenu_css__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_componentItem__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_ProviderList__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__stores_searchStore__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_throttle__ = __webpack_require__(123);
 ...
 */
class SearchMenu extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		...
		this.fitToDOM = __WEBPACK_IMPORTED_MODULE_8_lodash_throttle__(this.fitToDOM, 200);
	}
	componentDidUpdate() {
	...
	componentWillMount() {
		var self = this;
		__WEBPACK_IMPORTED_MODULE_7__stores_searchStore__["a" /* Store */].addListener({ field: "list" }, function (err, data) {
			let FTD = true;
		...
		__WEBPACK_IMPORTED_MODULE_7__stores_searchStore__["b" /* Actions */].setActionPress(function (direction) {
	...
	listItemClick(provider, item, action) {
		__WEBPACK_IMPORTED_MODULE_7__stores_searchStore__["b" /* Actions */].listItemClick(provider, item, action);
		fin.desktop.Window.getCurrent().blur();
		fin.desktop.Window.getCurrent().hide();
	}
	providerClick(provider) {
		__WEBPACK_IMPORTED_MODULE_7__stores_searchStore__["b" /* Actions */].providerItemClick(provider);
	}
	getBestMatch() {
		var bestMatch = null;
	...
	keyPress(event) {
		...
		if (events.includes(event.key)) {
			__WEBPACK_IMPORTED_MODULE_7__stores_searchStore__["b" /* Actions */].actionPress(null, { data: event.key });
		}
	}
	buildList() {
		...
		this.state.componentList.map(function (providerInfo, providerIndex) {
			...
			var elementList = providerInfo.data.map(function (component, index) {
				...
				var item = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_componentItem__["a" /* default */], { isBestMatch: isBestMatch, isActive: isActive ? true : false, ref: "item" + index, key: "comp" + index,
			...
			listElements.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_6__components_ProviderList__["a" /* default */],
				{ onClick: self.providerClick, key: "provider." + providerIndex, providerInfo: providerInfo, displayContainter: showProvider },
				elementList
			));
		});
		if (!listElements.length) return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			"div",
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			"div",
			null,
			totalElements >= 1 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				null,
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "bestMatch searchHeader" },
					"Best Match"
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					null,
					bestMatch ? bestMatch.component : null
				)
			) : null,
			listElements
		);
...
fin.desktop.main(function () {
	...
	function FSBLReady() {
		...
		__WEBPACK_IMPORTED_MODULE_7__stores_searchStore__["c" /* initialize */](function (store) {
			menuStore = store;
			__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(SearchMenu, null), document.getElementById("bodyHere"));
		});
	}
});
...
/******/ });
//# sourceMappingURL=searchMenu.map.js