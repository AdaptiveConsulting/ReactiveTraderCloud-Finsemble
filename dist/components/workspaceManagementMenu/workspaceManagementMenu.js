...
class WorkspaceActions extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
		this.userActions = [{
  ...
  */
	createWorkspace() {
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].blurWindow();
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].newWorkspace();
	}
  ...
  */
	saveWorkspace() {
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].blurWindow();
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].saveWorkspace();
	}
  ...
  */
	saveWorkspaceAs() {
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].blurWindow();
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].saveWorkspaceAs();
	}
	showPreferences() {
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].blurWindow();
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].showPreferences();
	}
	/**
  * Render method.
  *
   ...
   */
		var workspaceActions = this.userActions.map(function (action, index) {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleMenuItem"],
				{ key: index },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleMenuItemLabel"],
					{ onClick: action.method, className: "menu-item-fullwidth workspace-action" },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: action.iconClass }),
					" ",
					action.label
				)
			);
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleMenuSection"],
			{ className: "menu-secondary workspace-actions" },
			workspaceActions
		);
	}
}
/* harmony export (immutable) */ __webpack_exports__["a"] = WorkspaceActions;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__workspace__ = __webpack_require__(184);
...
class WorkspaceManagementList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		WorkspaceManagementMenuStore = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__stores_workspaceManagementMenuStore__["d" /* getStore */])();
  ...
  */
	removeWorkspace(workspaceName) {
		__WEBPACK_IMPORTED_MODULE_4__stores_workspaceManagementMenuStore__["c" /* Actions */].removeWorkspace(workspaceName);
	}
  ...
  */
	togglePin(workspaceName) {
		__WEBPACK_IMPORTED_MODULE_4__stores_workspaceManagementMenuStore__["c" /* Actions */].togglePin(workspaceName);
	}
	onDragEnd(changeEvent) {
		//User didn't make a valid drop.
		if (!changeEvent.destination) return;
		__WEBPACK_IMPORTED_MODULE_4__stores_workspaceManagementMenuStore__["c" /* Actions */].reorderWorkspaceList(changeEvent);
	}
	/**
  * Render method.
  *
  ...
  */
	render() {
		...
		let workspaces = this.props.workspaces.map(function (workspace, i) {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleDraggable"],
				{
					index: i,
					key: i,
					draggableId: workspace.name },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__workspace__["a" /* default */], {
					key: i,
					isActiveWorkspace: isActiveWorkspace,
					workspace: workspace,
					mainAction: __WEBPACK_IMPORTED_MODULE_4__stores_workspaceManagementMenuStore__["c" /* Actions */].switchToWorkspace,
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleDnDContext"],
			{ onDragEnd: this.onDragEnd },
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleMenuSection"],
				{ className: "menu-primary" },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleDroppable"],
					{ direction: "vertical", droppableId: "workspaceList" },
					workspaces
				)
			)
		);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = WorkspaceManagementList;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./workspaceManagementMenu.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./workspaceManagementMenu.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__workspaceManagementMenu_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__workspaceManagementMenu_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__assets_css_font_finance_css__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__assets_css_font_finance_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__assets_css_font_finance_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__assets_css_finsemble_css__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__assets_css_finsemble_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__assets_css_finsemble_css__);
/*!
* Copyright 2017 by ChartIQ, Inc.
* All rights reserved.
*/
...
class WorkspaceManagementMenu extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
		this.bindCorrectContext();
		this.state = {
			WorkspaceList: __WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].getWorkspaceList(),
			activeWorkspace: __WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].getActiveWorkspace(),
	...
	convertPinnedWorkspacesToArray() {
		var pins = __WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].getPins();
		var arr = [];
		pins.forEach(pin => {
			arr.push(pin.label);
		});
	...
	onStoreChange() {
		this.setState({
			...
			__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["c" /* Actions */].setHeight();
		});
	}
	...
	componentWillMount() {
		WorkspaceManagementMenuStore.addListeners([{ field: "WorkspaceList", listener: this.onStoreChange }, { field: "activeWorkspace", listener: this.onStoreChange }, { field: "pins", listener: this.onPinChange }]);
	}

	componentWillUnmount() {
		WorkspaceManagementMenuStore.removeListeners([{ field: "WorkspaceList", listener: this.onStoreChange }, { field: "activeWorkspace", listener: this.onStoreChange }, { field: "pins", listener: this.onPinChange }]);
	}

	render() {
		var self = this;
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			__WEBPACK_IMPORTED_MODULE_5__chartiq_finsemble_react_controls__["FinsembleMenu"],
			null,
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_workspaceActions__["a" /* default */], null),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_workspaceList__["a" /* default */], {
...
fin.desktop.main(function () {
	...
	function FSBLReady() {
		...
		__WEBPACK_IMPORTED_MODULE_2__stores_workspaceManagementMenuStore__["a" /* initialize */](function (store) {
			WorkspaceManagementMenuStore = store;
			__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(WorkspaceManagementMenu, null), document.getElementById("workspaceManagementMenu-component-wrapper"));
		});
	}
});
...
class Workspace extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		this.bindCorrectContext();
	}
  ...
  */
	renderButtons() {
		...
		return itemActions.map(function (action, index) {
			...
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ key: index, className: classes, onClick: () => {
						action.method(workspace);
					} },
				action.iconClass && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: iconClasses })
			);
		});
	}
	/**
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			showSpinner && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ className: "fsbl-loader" },
				"Loading..."
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__chartiq_finsemble_react_controls__["FinsembleMenuItemLabel"], { label: workspace.name, className: classes, onClick: this.onClick }),
			actionButtons && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
...
/******/ });
//# sourceMappingURL=workspaceManagementMenu.map.js