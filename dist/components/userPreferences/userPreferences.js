...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return WorkspaceManagementGlobalStore; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getStore; });
...
Actions = {
  ...
  */
	newWorkspace: function () {
		...
		Actions.blurWindow();
		let tasks = [Actions.autoSave, Actions.spawnWorkspaceInputField, Actions.validateWorkspaceInput, Actions.checkIfWorkspaceAlreadyExists, Actions.askIfUserWantsNewWorkspace, createIt, Actions.notifyUserOfNewWorkspace];
		if (PROMPT_ON_SAVE) {
			tasks = [Actions.askIfUserWantsToSave, Actions.handleSaveDialogResponse].concat(tasks);
		}
		__WEBPACK_IMPORTED_MODULE_0_async___default.a.waterfall(tasks, Actions.onAsyncComplete);
	},
	/**
  ...
  */
	...
	renameWorkspace: function ({ oldName, newName }) {
		...
		__WEBPACK_IMPORTED_MODULE_0_async___default.a.waterfall([Actions.checkIfWorkspaceAlreadyExists.bind(null, { value: newName }), (result, callback) => {
			if (result.workspaceExists) {
				callback(null, FSBL.Clients.WorkspaceClient.getWorkspaceName(newName));
			} else {
				callback(null, newName);
			}
		}, saveIt], Actions.onAsyncComplete);
	},
  ...
  */
	saveWorkspaceAs: function () {
		...
		__WEBPACK_IMPORTED_MODULE_0_async___default.a.waterfall([Actions.autoSave, Actions.spawnSaveAsDialog, Actions.validateWorkspaceInput, Actions.checkIfWorkspaceAlreadyExists, Actions.askAboutOverwrite, saveIt], Actions.onAsyncComplete);
	},
	/**
...
function initialize(cb) {
	...
	__WEBPACK_IMPORTED_MODULE_0_async___default.a.parallel([createGlobalStore, createLocalStore, getToolbarStore, getPreferences], function () {
		Actions.initialize();
...
const async = __webpack_require__(42);
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                this.props.checked && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "ff-check-mark" })
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "complex-menu-checkbox-label" },
                this.props.label
            )
        );
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__content_General__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__content_Toolbar__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__content_Workspaces__ = __webpack_require__(170);
...
let content = {
	general: __WEBPACK_IMPORTED_MODULE_1__content_General__["a" /* default */],
	toolbar: __WEBPACK_IMPORTED_MODULE_2__content_Toolbar__["a" /* default */],
	workspaces: __WEBPACK_IMPORTED_MODULE_3__content_Workspaces__["a" /* default */]
};
class ContentSection extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
	}
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'div',
			{ className: 'complex-menu-content-row' },
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ className: 'complex-menu-header' },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { onClick: this.hideWindow, className: 'ff-close complex-menu-close' })
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Component, null)
		);
	}
}
/* harmony export (immutable) */ __webpack_exports__["a"] = ContentSection;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__);



class LeftNav extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    setActiveSection(name) {
        let activeSection = __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].getValue({ field: 'activeSection' });
        if (activeSection !== name) {
            this.setState({
                activeSection: name
            });
            __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].setValue({ field: 'activeSection', value: name });
        }
    }
    componentDidMount() {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { className: 'complex-menu-left-nav' },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'complex-menu-left-nav-header' },
                'Preferences'
            ),
            navEntries.map((el, i) => {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: sectionToggleClasses, key: i, onClick: () => {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LeftNav;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./userPreferences.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./userPreferences.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = {"Entries":[{"name":"general","label":"General"},{"name":"workspaces","label":"Workspaces"}]}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__userPreferences_css__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__userPreferences_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__userPreferences_css__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_LeftNav__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_ContentSection__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__workspaceManagementMenu_src_stores_workspaceManagementMenuStore__ = __webpack_require__(45);
/*!
* Copyright 2017 by ChartIQ, Inc.
* All rights reserved.
*/
...
class UserPreferences extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
	...
	addListeners() {
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].addListener({ field: "activeSection" }, this.setActiveSection);
	}
	...
	render() {
		let navConfig = __webpack_require__(134);
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			"div",
			{ className: "user-preferences" },
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ className: "complex-menu-wrapper" },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__components_LeftNav__["a" /* default */], { entries: navConfig.Entries }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_ContentSection__["a" /* default */], { activeSection: this.state.activeSection })
			)
		);
	}
}
...
function FSBLReady() {
	...
	__WEBPACK_IMPORTED_MODULE_8__workspaceManagementMenu_src_stores_workspaceManagementMenuStore__["a" /* initialize */](() => {
		WorkspaceManagementMenuGlobalStore = __WEBPACK_IMPORTED_MODULE_8__workspaceManagementMenu_src_stores_workspaceManagementMenuStore__["b" /* GlobalStore */];
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["initialize"])(WorkspaceManagementMenuGlobalStore, store => {
			__WEBPACK_IMPORTED_MODULE_5_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(UserPreferences, null), document.getElementById("UserPreferences-component-wrapper"));
		});
	});
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__general_ScheduledRestart__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__general_Toolbar__ = __webpack_require__(172);




class General extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
    }
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__general_ScheduledRestart__["a" /* default */], null),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__general_Toolbar__["a" /* default */], null)
        );
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = General;
...
class Toolbar extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            { className: "complex-menu-content-section" },
            " Toolbar section "
        );
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__checkbox__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_async__ = __webpack_require__(42);
...
class WorkspaceEditor extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		this.state = {
			value: props.value || "",
	...
	render() {
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { onFocus: this.onFocus, onBlur: this.onBlur, autoFocus: true, value: this.state.value, className: 'workspace-editor', onChange: this.onChange, onKeyDown: this.onKeyDown });
	}
}

class Workspaces extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		this.state = {
			adding: false,
	...
	addListeners() {
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].addListener({ field: 'WorkspaceList' }, this.setWorkspaceList);
	}
	...
	onDragEnd(changeEvent) {
		...
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["WorkspaceManagementMenuStore"].Dispatcher.dispatch({ actionType: "reorderWorkspace", data: changeEvent });
	}
	...
	getComponentTypes(templateObject) {
		...
		for (let i = 0; i < templateObject.windows.length; i++) {
			...
			if (windowData) {
				// current assimulation doesn't fill in windowData, so in this case use "Unknown Component" for component type
	...
	renameWorkspace(newName) {
		...
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["WorkspaceManagementMenuStore"].Dispatcher.dispatch({
	...
	componentDidMount() {
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].addListener({ field: 'preferences' }, this.setPreferences);
		FSBL.Clients.ConfigClient.getPreferences((err, data) => {
			this.setPreferences(err, { value: data });
		});
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].getValue({ field: "WorkspaceList" }, (err, data) => {
			if (data && data.length) {
				this.setState({
					workspaceList: data
				});
	...
	componentWillUnmount() {
		__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].removeListener({ field: 'preferences' }, this.setPreferences);
	}
	...
	importWorkspace(evt) {
		...
		__WEBPACK_IMPORTED_MODULE_4_async___default.a.each(files, loadFile, () => {
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'div',
			null,
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { style: { display: 'none' }, type: 'file', id: 'file-input' }),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ className: 'complex-menu-content-row' },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'workspace-list-header-row' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'content-section-header workspace-list-header' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ ref: 'WorkspaceList', className: 'workspace-list' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							__WEBPACK_IMPORTED_MODULE_2__chartiq_finsemble_react_controls__["FinsembleDnDContext"],
							{ onDragEnd: this.onDragEnd },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								__WEBPACK_IMPORTED_MODULE_2__chartiq_finsemble_react_controls__["FinsembleDroppable"],
								{ direction: 'vertical', droppableId: 'workspace-list' },
								this.state.workspaceList.map((workspace, i) => {
									...
									if (this.state.focusedWorkspace === workspace.name) {
										...
										if (this.state.editing || this.state.adding) {
											...
											return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												...
												__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(WorkspaceEditor, { alue: workspace.name,
									...
									return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
										__WEBPACK_IMPORTED_MODULE_2__chartiq_finsemble_react_controls__["FinsembleDraggable"],
										{ onClick: () => this.setFocusedWorkspace(workspace.name), wrapperClass: classNames, draggableId: workspace.name, key: i, index: i },
										__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
											'div',
										...
										__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
											'div',
											{ className: 'individual-workspace-actions' },
											__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'div',
												{ title: renameTooltip, className: renameButtonClasses, onMouseDown: this.handleButtonClicks, onClick: allowRename ? () => {
														this.startEditingWorkspace(workspace.name);
													} : Function.prototype },
												__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'ff-edit' })
											),
											workspace.name !== FSBL.Clients.WorkspaceClient.activeWorkspace.name && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'div',
												{ title: deleteTooltip, className: deleteButtonClasses, onMouseDown: this.handleButtonClicks, onClick: allowDelete ? () => {
														this.deleteWorkspace(workspace.name);
													} : Function.prototype },
												__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'ff-delete' })
											)
										)
									);
								})
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'workspace-component-list' },
							this.state.focusedWorkspaceComponentList.length > 0 && this.state.focusedWorkspaceComponentList.map((cmp, i) => {
								return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									{ key: i, className: 'workspace-component' },
									cmp
								);
							}),
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'div',
							{ className: 'workspace-action-buttons' },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ title: importTooltip, className: importButtonClasses, onMouseDown: this.handleButtonClicks, onClick: allowImport ? this.openFileDialog : Function.prototype },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'workspace-action-button-icon ff-import' }),
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									null,
									'Import'
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								'div',
								{ title: exportTooltip, className: exportButtonClasses, onMouseDown: this.handleButtonClicks, onClick: allowExport ? this.exportWorkspace : Function.prototype },
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'workspace-action-button-icon ff-export' }),
								__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									'div',
									null,
									'Export'
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Workspaces;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checkbox__ = __webpack_require__(105);
...
class ScheduledRestart extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    toggleEnabled() {
        ...
        if (!enabled) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Actions"].disableScheduledRestart();
        } else {
            this.setState({ enabled });
            __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Actions"].setScheduledRestart(scheduledRestart);
        }
    }
    ...
    componentDidMount() {
        __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].addListener({ field: 'preferences' }, this.setPreferences);
        __WEBPACK_IMPORTED_MODULE_1__stores_UserPreferencesStore__["Store"].getValue({ field: "preferences" }, (err, data) => {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'span',
                    { className: 'scheduled-restart-select-label' },
                    'Time:'
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'select',
                    { disabled: !enabled, onChange: this.setHour, value: this.getDisplayHour() },
                    HOURS.map((hour, i) => {
                        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            'option',
                            { key: i, value: hour },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'select',
                    { disabled: !enabled, value: scheduledRestart.minute, onChange: this.setMinute },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'select',
                    { disabled: !enabled, onChange: this.setMeridiem, value: scheduledRestart.meridiem },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'option',
                        { value: "AM" },
                        'AM'
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ScheduledRestart;
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"span",
					null,
					"Display toolbar on monitor"
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"select",
					{ style: { margin: "0px 10px" }, onChange: this.setMonitor, value: this.state.monitor },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"option",
						{ value: "all" },
						"All"
...
/***/ })
/******/ ]);
//# sourceMappingURL=userPreferences.map.js