...
const timesSeries = __webpack_require__(145);
let ProcessMonitorStore;
const asyncEach = __webpack_require__(135);
...
const SIMPLE_MODE_STATISTICS = [{ label: "CPU", value: "cpuUsage" }, { label: "Memory", value: "workingSetSize" }];
/* harmony export (immutable) */ __webpack_exports__["b"] = SIMPLE_MODE_STATISTICS;

//Same as Simple, but we also give peak memory.
const ADVANCED_MODE_STATISTICS = [{ label: "CPU", value: "cpuUsage" }, { label: "Memory", value: "workingSetSize" }, { label: "Peak Memory", value: "peakWorkingSetSize" }, { label: "PID", value: "processId" }];
/* harmony export (immutable) */ __webpack_exports__["c"] = ADVANCED_MODE_STATISTICS;

//These are percentages
const HIGH_CPU = 10;
/* harmony export (immutable) */ __webpack_exports__["g"] = HIGH_CPU;

const MODERATE_CPU_USAGE = 5;
/* harmony export (immutable) */ __webpack_exports__["h"] = MODERATE_CPU_USAGE;


//Usage in MB
const MODERATE_MEMORY_USAGE = 250;
/* harmony export (immutable) */ __webpack_exports__["f"] = MODERATE_MEMORY_USAGE;

const HIGH_MEMORY_USAGE = 400;
/* harmony export (immutable) */ __webpack_exports__["d"] = HIGH_MEMORY_USAGE;


//so the constants above can be in MB. This is just a multiplier.
const TO_MB = 1000000;
/* harmony export (immutable) */ __webpack_exports__["e"] = TO_MB;
...
const EMPTY_TOTALS = emptyTotals;
/* harmony export (immutable) */ __webpack_exports__["a"] = EMPTY_TOTALS;
...
"use strict";
/* unused harmony export toProperCase */
/* harmony export (immutable) */ __webpack_exports__["c"] = bytesToSize;
/* harmony export (immutable) */ __webpack_exports__["a"] = statReducer;
 ...
 * @param {*} curr
 */
function statReducer(prev, curr) {
    let ret = {
        name: "Totals",
        uuid: "Totals",
        statistics: {}
    };
    __WEBPACK_IMPORTED_MODULE_0__constants__["b" /* SIMPLE_MODE_STATISTICS */].forEach(stat => {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ChildWindow__ = __webpack_require__(163);



/** This component could _probably_ be removed. It's just an array of child windows. */
class ChildWindows extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
    }
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            this.props.childWindows.map((cw, i) => {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__ChildWindow__["a" /* default */], { key: i, viewMode: this.props.viewMode, cw: cw });
            })
        );
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = ChildWindows;
...
class ListHeader extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
        this.state = {
            sort: __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Store"].getValue({ field: "sort" })
        };
    ...
    componentWillMount() {
        __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Store"].addListener({ field: "sort" }, this.onSortChanged);
    }

    componentWillUnmount() {
        __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Store"].removeListener({ field: "sort" }, this.onSortChanged);
    }
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "list-header-statistic-label list-header-name", onClick: () => {
                        __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Actions"].setSort("name");
                    } },
                "Name",
                this.state.sort.field === "name" ? this.state.sort.direction === "ascending" ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "sort-direction ff-arrow-up" }) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "sort-direction ff-arrow-down" }) : null
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "list-header-statistic-labels" },
                this.props.fields.map((field, i) => {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { key: i, className: "list-header-statistic-label", onClick: () => {
                                __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Actions"].setSort(field.value);
                            } },
                        field.label,
                        this.state.sort.field === field.value ? this.state.sort.direction === "ascending" ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "sort-direction ff-arrow-up" }) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "sort-direction ff-arrow-down" }) : null
                    );
                }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "list-header-statistic-label" })
            )
        );
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers__ = __webpack_require__(100);




//Not used right now. Currently using alerts. This is for the future.
class ProcessStatistics extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "process-statistics" },
                this.props.fields.map((field, i) => {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { key: i, className: getClassesForStat(this.props.stats[field.value], field.label) },
                        prettyPrint(this.props.stats[field.value], field.label)
                    );
                }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "statistic process-actions" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { className: " terminate fsbl-button-negative process-action", onClick: () => {
                                __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Actions"].terminateProcess(this.props.stats);
                            } },
                        "Terminate"
                    )
                )
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ProcessStatistics;
...
function getClassesForStat(number, statType) {
    let classes = "statistic",
        high_comparison = __WEBPACK_IMPORTED_MODULE_2__constants__["d" /* HIGH_MEMORY_USAGE */] * __WEBPACK_IMPORTED_MODULE_2__constants__["e" /* TO_MB */],
        moderate_comparison = __WEBPACK_IMPORTED_MODULE_2__constants__["f" /* MODERATE_MEMORY_USAGE */] * __WEBPACK_IMPORTED_MODULE_2__constants__["e" /* TO_MB */];

    if (statType === "CPU") {
        high_comparison = __WEBPACK_IMPORTED_MODULE_2__constants__["g" /* HIGH_CPU */], moderate_comparison = __WEBPACK_IMPORTED_MODULE_2__constants__["h" /* MODERATE_CPU_USAGE */];
    }
...
function prettyPrint(number, statType) {
    if (statType === "CPU") {
        //make it a percent.
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers__["b" /* round */])(number, 2) + "%";
    } else if (statType !== "processId") {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__helpers__["c" /* bytesToSize */])(number);
    } else {
        return number;
    }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./processMonitor.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./processMonitor.css");
...
var _eachOf = __webpack_require__(136);

var _eachOf2 = _interopRequireDefault(_eachOf);

var _withoutIndex = __webpack_require__(141);
...
var _eachOfLimit = __webpack_require__(64);
...
var _doParallelLimit = __webpack_require__(138);
...
var _mapLimit = __webpack_require__(142);

var _mapLimit2 = _interopRequireDefault(_mapLimit);

var _baseRange = __webpack_require__(205);
...
var _timesLimit = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ListHeader__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ProcessStatistics__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ChildWindows__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__processMonitor_css__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__processMonitor_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__processMonitor_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__constants__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__helpers__ = __webpack_require__(100);
...
class ProcessMonitor extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		this.state = {
			processList: [],
  ...
  */
	...
	componentDidMount() {
		__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__["Store"].addListener({ field: "processList" }, this.onProcessListChanged);
		__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__["Store"].addListener({ field: "viewMode" }, this.onViewModeChanged);
	}
	componentWillUnmount() {
		__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__["Store"].removeListener({ field: "processList" }, this.onProcessListChanged);
		__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__["Store"].removeListener({ field: "viewMode" }, this.onViewModeChanged);
	}
	...
	render() {
		...
		let totals = this.state.processList.length ? this.state.processList.reduce(__WEBPACK_IMPORTED_MODULE_8__helpers__["a" /* statReducer */]) : __WEBPACK_IMPORTED_MODULE_7__constants__["a" /* EMPTY_TOTALS */];
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			"div",
			null,
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_ListHeader__["a" /* default */], { fields: this.state.viewMode === "simple" ? __WEBPACK_IMPORTED_MODULE_7__constants__["b" /* SIMPLE_MODE_STATISTICS */] : __WEBPACK_IMPORTED_MODULE_7__constants__["c" /* ADVANCED_MODE_STATISTICS */] }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "process-list" },
					this.state.processList.filter(proc => proc.visible).map((proc, i) => {
						return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							"div",
							{ key: i, className: "process" },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_ProcessStatistics__["a" /* default */], {
								mode: this.state.viewMode,
								fields: this.state.viewMode === "simple" ? __WEBPACK_IMPORTED_MODULE_7__constants__["b" /* SIMPLE_MODE_STATISTICS */] : __WEBPACK_IMPORTED_MODULE_7__constants__["c" /* ADVANCED_MODE_STATISTICS */],
								stats: proc.statistics }),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_ChildWindows__["a" /* default */], { viewMode: this.state.viewMode, childWindows: proc.childWindows })
						);
					})
				)
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "summary-statistics-wrapper" },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ className: "summary-statistics-header" },
						"Finsemble Total Usage"
					),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ className: "summary-statistics" },
						typeof totals.statistics.cpuUsage !== "undefined" && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							"div",
							{ className: "summary-statistic" },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								"div",
								{ className: "summary-statistic-label" },
								"CPU"
							),
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								"div",
								{ className: "summary-statistic-number" },
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__helpers__["b" /* round */])(totals.statistics.cpuUsage, 2) + "%"
							)
						),
						typeof totals.statistics.workingSetSize !== "undefined" && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							"div",
							{ className: "summary-statistic" },
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								"div",
							...
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
								"div",
								{ className: "summary-statistic-number" },
								__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_8__helpers__["c" /* bytesToSize */])(totals.statistics.workingSetSize)
							)
						)
					)
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "advanced-button-wrapper" },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ className: "fsbl-button advanced-button", onClick: () => {
								__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__["Actions"].toggleViewMode();
							} },
...
/* harmony export (immutable) */ __webpack_exports__["default"] = ProcessMonitor;
...
function FSBLReady() {
	...
	__WEBPACK_IMPORTED_MODULE_2__stores_ProcessMonitorStore__["Actions"].initialize(function (store) {
		__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ProcessMonitor, null), document.getElementById("ProcessMonitor-component-wrapper"));
	});
}
 ...
 */
class ChildWindow extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor(props) {
        super(props);
    }
    render() {
        //If we're in simple mode, onClick does nothing. In advanced mode, we'll identify the window by making it flash.
        let cwClickHandler = this.props.viewMode === "simple" ? Function.prototype : () => {
            __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Actions"].identifyWindow(this.props.cw);
        };
        let childWindowClasses = `child-window ${this.props.viewMode}`;
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            { className: childWindowClasses },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "child-window-actions" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "close-window ff-close", onClick: () => {
                        __WEBPACK_IMPORTED_MODULE_1__stores_ProcessMonitorStore__["Actions"].closeWindow(this.props.cw);
                    } })
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "child-window-name", onClick: cwClickHandler },
                this.props.cw.name
            )
        );
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = ChildWindow;
...
// module
exports.push([module.i, "body {\r\n\tmargin: 0px;\r\n\toverflow: hidden;\r\n\tfont-size: var(--procMonitor-font-size);\r\n\tfont-weight: var(--procMonitor-font-weight);\r\n\tfont-family: var(--font-family);\r\n\tcolor: var(--procMonitor-font-color);\r\n\tbackground-color: var(--procMonitor-background-color);\r\n}\r\n\r\n\r\n.high-usage {\r\n\tbackground-color: var(--procMonitor-negative-background-color);\r\n\tcolor: var(--procMonitor-font-color);\r\n}\r\n\r\n.moderate-usage {\r\n\tbackground-color: var(--procMonitor-warning-background-color);\r\n\tcolor: var(--procMonitor-font-color);\r\n}\r\n\r\n.terminate {\r\n\tfont-style: normal;\r\n\tfont-stretch: normal;\r\n\tline-height: normal;\r\n\tletter-spacing: normal;\r\n\ttext-align: right;\r\n\tpadding: 3px 4px;\r\n\tcursor: pointer;\r\n\ttransition: all .25s ease;\r\n}\r\n\r\n.terminate:hover {\r\n\tborder-color: var(--procMonitor-negative-border-color);\r\n\tbackground-color: var(--procMonitor-negative-background-color);\r\n\tcolor: var(--procMonitor-font-color);\r\n}\r\n\r\n.process-list-wrapper {\r\n\tmargin: 1em;\r\n\tborder: 1px solid var(--procMonitor-list-border-color);\r\n}\r\n\r\n.process-list {\r\n\theight: calc(100vh - 185px);\r\n\toverflow-y: auto;\r\n}\r\n\r\n.process-row, .list-header {\r\n\tdisplay: flex;\r\n\tflex-direction: row;\r\n}\r\n\r\n.process {\r\n\tpadding-top: 8px;\r\n\tpadding-bottom: 8px;\r\n\tborder-bottom: 1px solid var(--procMonitor-list-border-color);\r\n}\r\n\r\n.list-header {\r\n\tborder-bottom: 1px solid var(--procMonitor-list-border-color);\r\n\tpadding-right: 15px;\r\n\talign-items: center;\r\n\t/*Account for scrollbar.*/\r\n}\r\n\r\n.process-name, .list-header-name {\r\n\twidth: 40%;\r\n}\r\n\r\n.process-name {\r\n\tfont-weight: var(--procMonitor-process-name-font-weight);\r\n\tfont-style: italic;\r\n\tpadding-left: 7px;\r\n}\r\n\r\n.process-statistics, .list-header-statistic-labels {\r\n\twidth: 60%;\r\n\tdisplay: flex;\r\n\talign-items: center;\r\n\tjustify-content: space-around;\r\n}\r\n\r\n.list-header-statistic-label {\r\n\tflex: 1;\r\n\tpadding: .5em;\r\n\tdisplay: inline-flex;\r\n\tjustify-content: center;\r\n\tcursor: pointer;\r\n}\r\n\r\n.list-header-name {\r\n\tborder-left: 0px;\r\n}\r\n\r\n.statistic {\r\n\tdisplay: inline-flex;\r\n\tjustify-content: center;\r\n\talign-content: center;\r\n\tflex: 1;\r\n}\r\n\r\n.child-window {\r\n\tdisplay: flex;\r\n\talign-content: center;\r\n\tline-height: 24px;\r\n}\r\n\r\n.child-window-name {\r\n\tfont-weight: var(--procMonitor-component-name-font-weight);\r\n}\r\n.advanced .child-window-name {\r\n\tcursor: pointer;\r\n}\r\n.child-window-actions {\r\n\tdisplay: inline-flex;\r\n\talign-content: center;\r\n}\r\n\r\n.summary-statistics-header {\r\n\tfont-weight: bold;\r\n\tfont-size: 15px;\r\n\tdisplay: flex;\r\n}\r\n\r\n.summary-statistics-wrapper, .summary-statistics, .summary-statistics-labels {\r\n\tdisplay: flex;\r\n}\r\n\r\n.summary-statistics {\r\n\twidth: 50%;\r\n}\r\n\r\n.summary-statistic {\r\n\tmargin-right: 40px;\r\n}\r\n\r\n.summary-statistics-wrapper {\r\n\tmargin-left: 19px;\r\n\tmargin-top: 6px;\r\n\tflex-direction: column;\r\n}\r\n\r\n.close-window {\r\n\tmargin-left: 5px;\r\n\tmargin-right: 17px;\r\n\theight: 8px;\r\n\twidth: 7px;\r\n\tcolor: var(--procMonitor-close-component-font-color);\r\n}\r\n\r\n.close-window:hover {\r\n\tcursor: pointer;\r\n\tcolor: var(--procMonitor-close-hover-color);\r\n}\r\n\r\n.sort-direction {\r\n\tfont-size: 8px;\r\n\tmargin-left: 5px;\r\n\tdisplay: flex;\r\n\talign-items: center;\r\n}\r\n\r\n.advanced-button-wrapper {\r\n\talign-self: center;\r\n\tdisplay: flex;\r\n\talign-content: center;\r\n\tmargin-right: 19px;\r\n}\r\n\r\n.advanced-button {\r\n\twidth: 110px;\r\n\theight: 35px;\r\n\tbackground-color: var(--button-neutral-background-color);\r\n\tborder: solid 1px var(--button-neutral-border-hover-color);\r\n\tcolor: var(--button-neutral-solid-font-color);\r\n\tdisplay:flex;\r\n\talign-content: center;\r\n\tjustify-content: center;\r\n\talign-items: center;\r\n\tcursor: pointer;\r\n}\r\n\r\n.bottom-section {\r\n\tdisplay:flex;\r\n\tjustify-content: space-between;\r\n}", ""]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=processMonitor.map.js