...
function createStore(done) {
	...
	FSBL.Clients.DistributedStoreClient.createStore({ store: "AppCatalog-Store" + finWindow.name, values: defaultData, global: false }, function (err, store) {
		menuStore = store;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_searchStore__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__AppList__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AppDetails__ = __webpack_require__(149);
/*!
* Copyright 2017 by ChartIQ, Inc.
* All rights reserved.
*/
...
class AppContent extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor() {
        super();
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: this.state.details ? "" : "hide" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__AppDetails__["a" /* default */], { item: this.state.details, backClick: this.onBackClick })
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: this.state.details ? "hide" : "" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__AppList__["a" /* default */], { detailsClick: this.onOpenDetails, installed: true })
            )
        );
    }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__menu_css__ = __webpack_require__(207);
...
class ComplexMenu extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
		this.bindCorrectContext();
		this.state = {
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "complex-menu-container" },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ className: "complex-menu-left-nav" },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							"div",
							{ className: "complex-menu-left-nav-header", style: headerImgStyle },
							self.props.headerImgUrl !== "" && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { className: "complex-menu-left-nav-header-img", src: self.props.headerImgUrl }),
							" ",
							this.props.title
						),
						navEntries.map((el, i) => {
							...
							if (el.label === this.state.activeSection) {
								...
								activeContent.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									"div",
									{ key: "entry" + i, className: "containerItem active" },
									el.content
								));
							} else {
								activeContent.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
									"div",
									{ key: "entry" + i, className: "containerItem" },
									el.content
								));
							}
							return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
/* harmony export (immutable) */ __webpack_exports__["a"] = ComplexMenu;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./appCatalog.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./appCatalog.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_css_finsemble_css__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_css_finsemble_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__assets_css_finsemble_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__appCatalog_css__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__appCatalog_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__appCatalog_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__complexMenu_ComplexMenu__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_AppContent__ = __webpack_require__(107);
/*!
* Copyright 2017 by ChartIQ, Inc.
* All rights reserved.
*/
 ...
 */
class AppCatalog extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		this.state = {
			loaded: false,
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__complexMenu_ComplexMenu__["a" /* default */], { headerImgUrl: this.state.headerImgUrl, title: "App Catalog", activeSection: "Apps", navOptions: [{
				label: "Apps",
				content: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__components_AppContent__["a" /* default */], { installed: true })
			}] });
	}
}
...
function FSBLReady() {
	...
	__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AppCatalog, null), document.getElementById("bodyHere"));
}
...
let menuStore;
class AppList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
		this.bindCorrectContext();
		this.state = {};
	...
	itemClick() {
		...
		setTimeout(() => {
			//we do this because the originating window doesn't exist in the launcher if we dont wait.
			FSBL.Clients.WindowClient.finsembleWindow.close();
			FSBL.Clients.DialogManager.hideModal();
		}, 100);
	}
	...
	createIcon() {
		if (!this.props.app.icon) {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { style: { backgroundImage: "url(src/assets/logo-placeholder-52.png)" }, className: "logo" });
		}
		if (this.props.app.icon.type === "fonticon") {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ className: "iconContainer" },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "icon " + this.props.app.icon.path })
			);
		}
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "footerLeft" }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					"div",
					{ className: "footerRight" },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						"div",
						{ className: "openButton", onClick: this.itemClick },
						"Open"
					)
				)
			)
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AppList;
...
class AppList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            { className: "AppDetailsContainer" },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { onClick: self.props.backClick, className: "ff-arrow-back" },
                " Back"
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "detailsHeader" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { style: { backgroundImage: "url(src/assets/logo-placeholder-52.png)" }, className: "logo" }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "titleContainer" },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { onClick: this.itemClick, className: "button" },
                    "Open"
                )
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
class AppList extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	bindCorrectContext() {
		this.onChangeDebounced = __WEBPACK_IMPORTED_MODULE_3_lodash_debounce__(this.onChangeDebounced, 200);
	...
	onChangeDebounced(e) {
		__WEBPACK_IMPORTED_MODULE_1__stores_searchStore__["a" /* Actions */].search(e.target.value);
	}
	itemClick() {}
	...
	componentWillMount() {
		var self = this;
		__WEBPACK_IMPORTED_MODULE_1__stores_searchStore__["b" /* initialize */](function (store) {
			menuStore = store;
	...
	render() {
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { className: "filterInput", onChange: this.onChange, placeholder: "Filter Apps" }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "ff-search" })
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ className: "appContainer" },
				this.state.appList.map(function (app, index) {
					return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__App__["a" /* default */], { key: "app" + index, openDetails: self.props.detailsClick, app: app });
				})
			)
		);
	}
