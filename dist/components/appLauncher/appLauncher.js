...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__stores_appLauncherStore__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__componentItem__ = __webpack_require__(152);
/*!
...
class appLauncherContainer extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
	...
	componentWillMount() {
		appLauncherStore = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__stores_appLauncherStore__["b" /* getStore */])();
	...
	launchComponent(component, params, cb) {
		...
		if (component.group) {
			for (let i of Object.keys(component.list)) {
				...
				__WEBPACK_IMPORTED_MODULE_1__stores_appLauncherStore__["c" /* Actions */].launchComponent(component.list[i], params, cb);
			}
		} else {
			if (component.component.windowGroup) {
				params.groupName = component.component.windowGroup;
			}
			__WEBPACK_IMPORTED_MODULE_1__stores_appLauncherStore__["c" /* Actions */].launchComponent(component, params, cb);
		}
	}
	togglePin(component) {
		__WEBPACK_IMPORTED_MODULE_1__stores_appLauncherStore__["c" /* Actions */].togglePin(component);
	}
	buildComponentItem(params) {
		...
		if ((!config.window || !config.foreign.components["App Launcher"] || !config.foreign.components["App Launcher"].launchableByUser) && !config.group) {
			return;
		}
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__componentItem__["a" /* default */], {
			isPinned: isPinned,
			key: key,
			name: key,
			component: config,
	...
	render() {
		...
		if (!componentList.length) {
			componentList = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"p",
				null,
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			__WEBPACK_IMPORTED_MODULE_2__chartiq_finsemble_react_controls__["FinsembleMenuSection"],
			{ maxHeight: 350, scrollable: true, className: "ComponentList menu-primary" },
			componentList
		);
	}
}
/* harmony export (immutable) */ __webpack_exports__["a"] = appLauncherContainer;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./appLauncher.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./appLauncher.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appLauncher_css__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appLauncher_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__appLauncher_css__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_componentList__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__stores_appLauncherStore__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls__);
/*!
* Copyright 2017 by ChartIQ, Inc.
* All rights reserved.
*/
 ...
 */
class AppLauncher extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
	...
	render() {
		var self = this;
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			__WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls__["FinsembleMenu"],
			null,
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				__WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls__["FinsembleMenuSection"],
				{ className: "menu-secondary" },
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					__WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls__["FinsembleMenuItem"],
					null,
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						__WEBPACK_IMPORTED_MODULE_7__chartiq_finsemble_react_controls__["FinsembleMenuItemLabel"],
						{ onClick: this.openAdHoc },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "ff-new-workspace" }),
						" New App"
					)
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						...
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("i", { className: "ff-list" }),
						" App Catalog"
					)
				)
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_componentList__["a" /* default */], null)
		);
	}
}
...
fin.desktop.main(function () {
	if (window.FSBL && FSBL.addEventListener) {
		...
		__WEBPACK_IMPORTED_MODULE_6__stores_appLauncherStore__["a" /* initialize */](function (store) {
			appLauncherStore = store;
			__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AppLauncher, null), document.getElementById("bodyHere"));
		});
	}
});
...
class componentItem extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor() {
		super();
		this.bindCorrectContext();
	...
	deleteItem() {
		__WEBPACK_IMPORTED_MODULE_1__stores_appLauncherStore__["c" /* Actions */].handleRemoveCustomComponent(this.props.name);
	}
  ...
  */
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__chartiq_finsemble_react_controls__["FinsembleMenuItem"], {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = componentItem;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getStore; });
...
var Actions = {
	initialize: function (cb) {
		__WEBPACK_IMPORTED_MODULE_0_async___default.a.parallel([Actions.initializeComponentList, Actions.getUserDefinedComponentList, setupHotkeys], function (err) {
			if (err) {
				console.error(err);
			}
...
function getToolbarStore(done) {
	FSBL.Clients.DistributedStoreClient.getStore({ global: true, store: "Finsemble-Toolbar-Store" }, function (err, store) {
		...
		store.getValue({ field: "pins" }, function (err, pins) {
			if (pins) {
				Actions.filterPinsFromToolbar(pins);
			}
		});

		store.addListener({ field: "pins" }, function (err, pins) {
			if (pins) {
				Actions.filterPinsFromToolbar(pins.value);
			}
		});
		done();
	});
...
function initialize(cb) {
	...
	__WEBPACK_IMPORTED_MODULE_0_async___default.a.parallel([createLocalStore, getToolbarStore, getWindowGroupStore, Actions.initialize], function (err) {
		if (err) {
			console.error(err);
		}
...
/******/ });
//# sourceMappingURL=appLauncher.map.js