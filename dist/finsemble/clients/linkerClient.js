 ...
 * See [OpenFin's FDC3 project](https://fdc3.org/) for an emerging industry standard taxonomy.
 * </p>
 *
 * <p>
...
var LinkerClient = function (params) {
	...
	*/
	...
	this.persistState = function (state) {
		// The idea behind this is that we don't want to update the permanent state if changes are the result of initialization. That would create a lot of unnecessary traffic.
		// However, this was causing problems with dirtying the workspace when a component was loaded a second time by a workspace. So for the time being, commenting this out.
		//if (this.dontPersistYet) return;
